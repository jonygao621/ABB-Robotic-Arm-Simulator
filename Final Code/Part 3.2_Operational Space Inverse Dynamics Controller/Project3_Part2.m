...
control_enable = true;
set_param('Project3_Part2_sim/control_enable', 'sw', int2str(control_enable))

%% Run Simulation
simTime = 10;
simOut =  sim('Project3_Part2_sim','SimulationMode','normal','AbsTol','1e-5','StopTime', int2str(simTime),...
